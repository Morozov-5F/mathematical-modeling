...
int lotka_volterra_cb(double t, const double y[], double dydt[], void *params)
{
    double prey_param_1 = ((double *)params)[0];
    double prey_param_2 = ((double *)params)[1];
    double predator_param_1 = ((double *)params)[2];
    double predator_param_2 = ((double *)params)[3];

    UNUSED(t);

    dydt[0] = prey_param_1 * y[0] - prey_param_2 * y[0] * y[1];
    dydt[1] = predator_param_1 * y[0] * y[1] - predator_param_2 * y[1];
