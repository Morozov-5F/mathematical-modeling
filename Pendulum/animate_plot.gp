...
do for [ii = 1:1000] {
    plot 'general1.dat' using 2:3 every ::1::ii w l ls 2, \
         ...
         'general6.dat' using 2:3 every ::1::ii w l ls 3, \
         'general6.dat' using 2:3 every ::ii::ii w p ls 3,\
         'general7.dat' using 2:3 every ::1::ii w l ls 4, \
         'general7.dat' using 2:3 every ::ii::ii w p ls 4,\
         'general8.dat' using 2:3 every ::1::ii w l ls 2, \
         'general8.dat' using 2:3 every ::ii::ii w p ls 2, \
